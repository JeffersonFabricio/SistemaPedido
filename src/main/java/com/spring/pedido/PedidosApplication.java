...
import com.spring.pedido.domain.Pagamento;
import com.spring.pedido.domain.PagamentoComBoleto;
import com.spring.pedido.domain.PagamentoComCartao;
...
public class PedidosApplication implements CommandLineRunner {
	...
	public void run (String... args) throws Exception {
		...
		Cliente cli1 = new Cliente(null, "Chica da Silva", "chica@email.com", "36378912377", TipoCliente.PESSOAFISICA);
		...
		Pedido ped1 = new Pedido(null, sdf.parse("07/06/2019 17:27"), cli1, e1);
		Pedido ped2 = new Pedido(null, sdf.parse("07/06/2019 17:27"), cli1, e2);
		
		Pagamento pagto1 = new PagamentoComCartao(null, EstadoPagamento.QUITADO, ped1, 6);

		ped1.setPagamento(pagto1);
		
		Pagamento pagto2 = new PagamentoComBoleto(null, EstadoPagamento.PENDENTE, ped2, sdf.parse("07/06/2019 17:43"), null);
